...
| [DevOps Labs](https://github.com/darestack/devops-labs) | Training portfolio with curated evidence paths for AWS HA WordPress, e-commerce CI/CD, Terraform modules, Ansible playbooks, and observability labs | Root README now separates implementation evidence from gaps; best screenshots, run links, and dashboard exports should be promoted next |
